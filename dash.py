...
def openImg_opencv(filename = 'new.jpg'):
    if os.path.exists(filename):
        image = io.imread(filename) #opencv
        print(image, '=====')
        return image
    else:
...
def main():
    ...
    # print(im1)
    img1 = 'http://jihepai-pro.oss-cn-hangzhou.aliyuncs.com/static/img/ac-main-default.jpg'
    img2 = 'http://jihepai-pro.oss-cn-hangzhou.aliyuncs.com/static/img/ac-main-default.jpg'
